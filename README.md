...
An unmanned aerial vehicle (UAV) with artificial eyesight this poor could not be trusted to telemetrically relay information about its environment in a reliable way. While the comparisons to nuclear war sound extreme, relying on AI to be the eyes and ears of any significant autonomous entity could even result in an inadvertent false flag, with emphasis on the inadvertent (in contrast to alarmist theories): https://en.wikipedia.org/wiki/False_flag
